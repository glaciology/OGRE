/*
   ...
   Derek Pickell 7/06/22, modified for telemetry.
   V1.0.6
...
#include <SparkFun_Swarm_Satellite_Arduino_Library.h> // NOTE: in .h file modification needed: define SWARM_M138_SOFTWARE_SERIAL_ENABLED
...
const byte SWARM_RX               = 9;        // Telemetry Related
