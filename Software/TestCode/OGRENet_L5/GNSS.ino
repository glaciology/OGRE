...
//    setValueSuccess &= gnss.sendCfgValset8(UBLOX_CFG_USB_ENABLED, 0);  // Disable USB
    ...
    success &= gnss.newCfgValset8(UBLOX_CFG_SIGNAL_GPS_L5_ENA, logGPS);  // Enable GPS L5
    ...
    success &= gnss.addCfgValset8(UBLOX_CFG_SIGNAL_GAL_E5A_ENA, logGAL); // Enable Galileo
