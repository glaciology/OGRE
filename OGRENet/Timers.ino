...
void configureWdt(){
  ...
  .ui16InterruptCount = 128, //MAX 255! // Set WDT interrupt timeout for 8 seconds (128 / 16 = 8).  // Number of watchdog timer ticks allowed before a watchdog interrupt event is generated.
  .ui16ResetCount = 240 //MAX 255! // Set WDT reset timeout for 15 seconds (240 / 16 = 15).  // Number of watchdog timer ticks allowed before the watchdog will issue a system reset.
  };
...
void configureLogAlarm() {
  ...
  // Manually set the RTC date and time
    rtc.setTime(13, 0, 0, 0, 1, 1, 21); // 13:00:00.000, June 3rd, 2020 (hund, ss, mm, hh, dd, mm, yy)
...
void configureSleepAlarm() {
  ...
  // Manually set the RTC date and time
    ...
    rtc.setAlarm(0, secondsSleep, 0, 13, 3, 6); // 13:00:00.000, June 3rd (hund, ss, mm, hh, dd, mm). Note: No year alarm register
